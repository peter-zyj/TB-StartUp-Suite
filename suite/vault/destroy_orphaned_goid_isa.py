...
def execute(IP,action):    
    ...
    dbfn = "/home/isa/Berkeley/ctnobj.lst"
    ...
    cmd4 = 'su - isa -c "cd Berkeley; ./dumpctn > /dev/null"'
    time.sleep(10)
...
def usage():
    ...
    print "Make sure that file:/home/isa/Berkeley/dumpctn are ready in the related folder"
    sys.exit(1)
